...
## 4.2 湾内における鉄の動態について
気仙沼湾における鉄の動態の知見を明らかにするために、2014年3月から2016年11月にかけての結果について評価を行った。降雨量指数と全測点全深度の鉄、窒素、リン濃度の相関係数を表２に示した。懸濁鉄(Particulate FE: P-FE：粒として溶けている鉄）はT-FEからD-FEの濃度を引くことで計算した。

  全ての鉄T-FE　－　溶存鉄F-FE　＝　懸濁鉄P-FE

降雨量指数とT-FE、P-FE濃度の相関係数は高く、測点3と11では99%の、測点8では95%の確率で有意であった。このことは、表層におけるT-FE濃度は、陸地由来の淡水流入と、河口からの距離の影響を強く受けることを示している。同様に、降雨量と窒素とリン濃度の相関係数も大川河口(測点11)で最も高い値が示された。

T-FEと塩分濃度、植物プランクトン濃度、懸濁度の相関を図9に示した。塩分とT-FEの相関は強く、測点3と11の表層でもっとも高い相関を示し、淡水が沿岸域に流入したときにT-FEの濃度が高くなることを示唆した。しかし、総鉄濃度（T-FE）は中層や底層では塩分濃度との相関は見られなかった。また表層であっても測点８と１５では緩い相関しか見られず、有意とは言えなかった。懸濁度とT-FE濃度はすべての測点で有意な相関関係が見られた。懸濁度とT-FEの相関は特に測点８の中層と底層で強くみられた。これらの結果は、河口からの距離と海水が鉄分濃度に影響することを表した。

測点１１と測点３の表層におけるT-FE濃度は、大川と東舞根川、西舞根川の影響を受けていることが明らかとなった。しかしながら、測点８における鉄分濃度は大川河口より遠いため、海洋由来の海水によって影響されていると考えられる。図１０は１５測点の表層における塩分濃度を示した。いくつかの測点を除いて、表層は０．１ｍ深度の水を用いている。測点１０では東舞根川と西舞根川の河口からの距離に対して塩分濃度が増加した。また、大川河口の測点１１および１２では塩分濃度は最も低かった一方、測点８では塩分濃度は高かった。
